...
exports.TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        function: {
            name: 'execute_code',
            description: 'Run a short Node.js, Python, or Bash snippet in a sandboxed, time-limited process and return stdout/stderr. Use for quick checks, not long-running programs.',
            parameters: {
                type: 'object',
                properties: {
