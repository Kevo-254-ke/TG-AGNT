...
export const TOOL_SCHEMAS: ToolDefinition[] = [
  ...
  },
  {
    ...
    function: {
      name: 'web_search',
      description:
        'Search the web using DuckDuckGo. Returns top results with title, URL, and snippet. Use this to find latest documentation, library versions, code examples, or verify current best practices before writing code. No API key required.',
      parameters: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    function: {
      name: 'fetch_webpage',
      description:
        'Fetch and extract text content from a specific webpage URL. Use after web_search to read documentation, blog posts, or GitHub pages in detail. Returns the page title and readable text content.',
      parameters: {
        type: 'object',
        properties: {
